...
module.exports = function (options, source) {
  ...
  for (key in source) {
    ...
    if (!FORCED && !PROTO && _typeof(targetProperty) == _typeof(sourceProperty)) continue;
...
var promise = new (_babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_0___default().resolve)();
_babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_1___default()(_context = [1, 2, 3]).call(_context, function (item) {
  return item > 1;
});
}();
/******/ })()
